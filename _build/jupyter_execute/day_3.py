...
Понижение размерности - это сжатие признаков датасета до более меньшего количества (размерности), при попытке не потерять информацию в них и их полезные свойства. 
